...
```
┌──────────────────────────────────────────┐
│ BarTender Printer v5.7.79  By---池鱼  [日志] [关于] [导出日志] │
│ [保存配置] [加载配置] [编辑数据源]            │
│ [加载校验数据] [✓启用校验] 已加载: N条       │
│                                            │
│ 模板目录：[D:\templates]        [浏览]      │
...
| 版本 | 大小 | 说明 |
|------|------|------|
| [v5.7.79](https://github.com/tall-1997/Label-Printer/releases/tag/v5.7.79) | ~50 MB | 账户、补打印、历史完整性与文件可靠性增强版 |
