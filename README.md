...
2. 点击“添加订单” → 填写客户、机型、颜色、订单号并选择模板
3. 在订单流程中配置数据源、增降序和长度规则
...
| 版本 | 大小 | 说明 |
|------|------|------|
| [v5.7.27](https://github.com/tall-1997/Label-Printer/releases/tag/v5.7.27) | ~49 MB | C# WinForms 当前用户安装版 |
