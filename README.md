...
**v5.7.90** - C# WinForms 完整 MES 工作流版
...
```
┌──────────────────────────────────────────┐
│ BarTender Printer v5.7.90  By---池鱼  [日志] [关于] [导出日志] │
│ [保存配置] [加载配置] [编辑数据源]            │
│ [加载校验数据] [✓启用校验] 已加载: N条       │
│                                            │
│ 模板目录：[D:\templates]        [浏览]      │
...
| 版本 | 大小 | 说明 |
|------|------|------|
| [v5.7.90](https://github.com/tall-1997/Label-Printer/releases/tag/v5.7.90) | ~50 MB | 完整 MES 工作流、PostgreSQL v17、CSV 交换、工位隔离与安全加固版 |
